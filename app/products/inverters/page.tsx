...
// دیتای دسته‌بندی اینورترها
const categoryData = {
  name: "انواع اینورتر و درایو",
  description:
    "اینورترها و درایوهای فرکانس متغیر تجهیزاتی هستند که برای کنترل سرعت الکتروموتورهای AC استفاده می‌شوند. این دستگاه‌ها با تغییر فرکانس و ولتاژ ورودی، امکان کنترل دقیق سرعت و گشتاور موتور را فراهم می‌کنند.",
  image: "/inverter.png",
  subcategories: [
    {
      name: "اینورتر تک فاز",
      description: "اینورترهای تک فاز برای کنترل موتورهای کوچک و متوسط",
      image: "/placeholder.svg?height=200&width=300",
      slug: "single-phase",
    },
    {
      name: "اینورتر سه فاز",
      description: "اینورترهای سه فاز صنعتی برای کنترل موتورهای قدرتمند",
      image: "/placeholder.svg?height=200&width=300",
      slug: "three-phase",
    },
    {
      name: "اینورتر ولتاژ پایین",
      description: "اینورترهای ولتاژ پایین برای کاربردهای عمومی",
      image: "/placeholder.svg?height=200&width=300",
      slug: "low-voltage",
    },
    {
      name: "اینورتر ولتاژ متوسط",
      description: "اینورترهای ولتاژ متوسط برای کاربردهای صنعتی سنگین",
      image: "/placeholder.svg?height=200&width=300",
      slug: "medium-voltage",
    },
    {
      name: "اینورتر سروو درایو",
      description: "درایوهای سروو برای کنترل دقیق موقعیت و سرعت",
      image: "/placeholder.svg?height=200&width=300",
      slug: "servo-drive",
    },
    {
      name: "اینورتر ویژه",
      description: "اینورترهای ویژه برای کاربردهای خاص مانند آسانسور و جرثقیل",
      image: "/placeholder.svg?height=200&width=300",
      slug: "special",
    },
  ],
  products: [
    {
      id: 1,
      name: "اینورتر زیمنس مدل G120C 5.5 کیلووات",
      price: 28500000,
      discountPrice: 26800000,
      rating: 4.8,
      image: "/placeholder.svg?height=300&width=300",
      isNew: true,
      slug: "siemens-g120c-5.5kw",
      brand: "زیمنس",
      inStock: true,
    },
    {
      id: 2,
      name: "اینورتر ABB مدل ACS580 7.5 کیلووات",
      price: 32000000,
      discountPrice: null,
      rating: 4.7,
      image: "/placeholder.svg?height=300&width=300",
      isNew: false,
      slug: "abb-acs580-7.5kw",
      brand: "ABB",
      inStock: true,
    },
    {
      id: 3,
      name: "اینورتر شنایدر مدل ATV320 3 کیلووات",
      price: 18900000,
      discountPrice: 17500000,
      rating: 4.5,
      image: "/placeholder.svg?height=300&width=300",
      isNew: false,
      slug: "schneider-atv320-3kw",
      brand: "شنایدر",
      inStock: true,
    },
    {
      id: 4,
      name: "اینورتر دانفوس مدل FC-302 11 کیلووات",
      price: 42000000,
      discountPrice: 39500000,
      rating: 4.9,
      image: "/placeholder.svg?height=300&width=300",
      isNew: true,
      slug: "danfoss-fc302-11kw",
      brand: "دانفوس",
      inStock: false,
    },
    {
      id: 5,
      name: "اینورتر میتسوبیشی مدل FR-E800 2.2 کیلووات",
      price: 22500000,
      discountPrice: null,
      rating: 4.6,
      image: "/placeholder.svg?height=300&width=300",
      isNew: false,
      slug: "mitsubishi-fre800-2.2kw",
      brand: "میتسوبیشی",
      inStock: true,
    },
    {
      id: 6,
      name: "اینورتر LS مدل SV-iG5A 15 کیلووات",
      price: 38000000,
...
const filters = {
  brands: [
    ...
    { id: "mitsubishi", name: "میتسوبیشی" },
    { id: "ls", name: "LS" },
  ],
  price: [
    { id: "all", name: "همه قیمت‌ها" },
    { id: "under-25m", name: "کمتر از ۲۵ میلیون تومان" },
    { id: "25m-35m", name: "۲۵ تا ۳۵ میلیون تومان" },
    { id: "over-35m", name: "بیشتر از ۳۵ میلیون تومان" },
  ],
  availability: [
    { id: "all", name: "همه" },
        ...
        <div className="p-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
            {categoryData.subcategories.map((subcat, index) => (
              <Link key={index} href={`/products/inverters/${subcat.slug}`} className="group">
        ...
        <div className="lg:col-span-3">
              ...
              {categoryData.products.map((product) => (
                <Card key={product.id} className="overflow-hidden">
                  ...
                  <CardContent className="p-4">
                    ...
                    <Link href={`/products/inverters/${product.slug}`}>
          ...
          <div className="bg-white dark:bg-gray-900 rounded-xl shadow-md p-6">
            ...
            <div className="prose prose-sm dark:prose-invert max-w-none">
              ...
              <p>
                اینورترها و درایوهای فرکانس متغیر در انواع مختلفی مانند تک فاز، سه فاز، ولتاژ پایین، ولتاژ متوسط، سروو
                درایو و ویژه تولید می‌شوند که هر کدام برای کاربردهای خاصی مناسب هستند. این محصولات با بالاترین کیفیت و
                استانداردهای جهانی تولید شده‌اند و برای کاربردهای مختلف صنعتی مناسب هستند.
              </p>
              <p>
                برای مشاوره و راهنمایی بیشتر در مورد انتخاب اینورتر مناسب، می‌توانید با کارشناسان ما تماس بگیرید یا از
